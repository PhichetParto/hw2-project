...
<template>
  <div style="width: 500px; margin: auto">
    ...
    <div><input id="weight" v-model="weight" type="text" /></div>
    <div><label>ส่วนสูง (cm.)</label></div>
    <div><input id="height" v-model="height" type="text" /></div>
    ...
    <div v-else-if="result >= 25 && result <= 29.9">
      ...
      <ol>
        ...
        <li>
          วรฝึกความแข็งแรงของกล้ามเนื้อ ด้วยการฝึกกายบริหารหรือยกน้ำหนัก
          จะช่วยเสริมให้ร่างกายมีการใช้พลังงานเพิ่มมากขึ้น ทำให้ไขมันลดลง
        </li>
        <li>
